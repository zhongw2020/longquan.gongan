...
//      1.横向扩展：如需添加额外的属性，可新建文件“StorWarnInputDto.cs”的分部类“public partial class StorWarnInputDto”}添加属性
// </auto-generated>
//
//  <copyright file="StorWarnInputDto.generated.cs" company="longquan.gongan">
//      longquan.gongan
//  </copyright>
...
namespace longquan.gongan.AllReport.Dtos
{
    ...
    /// 输入DTO：库存量告警信息
    /// </summary>
    [MapTo(typeof(StorWarn))]
    [Description("库存量告警信息")]
    public partial class StorWarnInputDto : IInputDto<int>
    {
        /// <summary>
        /// 获取或设置 编号
        /// </summary>
