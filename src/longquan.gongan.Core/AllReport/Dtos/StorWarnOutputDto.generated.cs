...
//      1.横向扩展：如需添加额外的属性，可新建文件“StorWarnOutputDto.cs”的分部类“public partial class StorWarnOutputDto”}添加属性
// </auto-generated>
//
//  <copyright file="StorWarnOutputDto.generated.cs" company="longquan.gongan">
//      longquan.gongan
//  </copyright>
...
namespace longquan.gongan.AllReport.Dtos
{
    /// <summary>
    /// 输入DTO：库存量告警信息
    /// </summary>
    [MapFrom(typeof(StorWarn))]
    [Description("库存量告警信息")]
    public partial class StorWarnOutputDto : IOutputDto, IDataAuthEnabled
    {
        /// <summary>
        /// 初始化一个<see cref="StorWarnOutputDto"/>类型的新实例
        /// </summary>
        public StorWarnOutputDto()
        { }

        /// <summary>
        /// 初始化一个<see cref="StorWarnOutputDto"/>类型的新实例
        /// </summary>
        public StorWarnOutputDto(StorWarn entity)
        {
            Id = entity.Id;
