...
//      1.横向扩展：如需添加额外的属性，可新建文件“StorWarn.cs”的分部类“public partial class StorWarn”}添加属性
// </auto-generated>
//
//  <copyright file="StorWarn.generated.cs" company="longquan.gongan">
//      longquan.gongan
//  </copyright>
...
namespace longquan.gongan.AllReport.Entities
{
    /// <summary>
    /// 实体类：库存量告警信息
    /// </summary>
    [Description("库存量告警信息")]
    [TableNamePrefix("AllReport")]
    public partial class StorWarn : EntityBase<int>, ICreationAudited<int>, IUpdateAudited<int>
    {
        /// <summary>
        /// 获取或设置 国标大类
        /// </summary>
