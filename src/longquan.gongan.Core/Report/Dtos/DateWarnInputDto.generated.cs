...
//      1.横向扩展：如需添加额外的属性，可新建文件“DateWarnInputDto.cs”的分部类“public partial class DateWarnInputDto”}添加属性
// </auto-generated>
//
//  <copyright file="DateWarnInputDto.generated.cs" company="longquan.gongan">
//      longquan.gongan
//  </copyright>
...
namespace longquan.gongan.Report.Dtos
{
    ...
    /// 输入DTO：质保期告警信息
    /// </summary>
    [MapTo(typeof(DateWarn))]
    [Description("质保期告警信息")]
    public partial class DateWarnInputDto : IInputDto<int>
    {
        /// <summary>
        /// 获取或设置 编号
        /// </summary>
