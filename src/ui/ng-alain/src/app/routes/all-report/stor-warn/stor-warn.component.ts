...
//  </once-generated>
//
//  <copyright file="stor-warn.module.ts" company="longquan.gongan">
//      longquan.gongan
//  </copyright>
...
@Component({
  selector: 'app-stor-warn',
  templateUrl: './stor-warn.component.html',
  styles: []
})
export class StorWarnComponent extends STComponentBase implements OnInit {

  constructor(injector: Injector) {
    super(injector);
    this.moduleName = 'storWarn';
  }
  ...
  protected GetSTColumns(): OsharpSTColumn[] {
    let columns: OsharpSTColumn[] = [
     ...
     // { title: '价值类型', index: 'ValueType', sort: true, editable: true, filterable: true, ftype: 'string' },
      { title: '数量合计', index: 'SumNum', sort: true, editable: true, filterable: true, type: 'number' },
