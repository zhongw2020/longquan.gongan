...
//  </once-generated>
//
//  <copyright file="date-warn.module.ts" company="longquan.gongan">
//      longquan.gongan
//  </copyright>
...
@Component({
  selector: 'app-date-warn',
  templateUrl: './date-warn.component.html',
  styles: []
})
export class DateWarnComponent extends STComponentBaseD implements OnInit {

  constructor(injector: Injector, private cdr: ChangeDetectorRef, xlsx: XlsxService) {
    super(injector, xlsx);
    this.moduleName = 'dateWarn';
  }
