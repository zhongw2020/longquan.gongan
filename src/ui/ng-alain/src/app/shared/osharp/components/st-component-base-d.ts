import { STColumn, STReq, STRes, STPage, STComponent, STData, STRequestOptions, STChange, STError, XlsxService } from '@delon/abc';
...
export abstract class STComponentBaseD {
  moduleName: string;
